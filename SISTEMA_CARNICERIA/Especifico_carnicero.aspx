<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Especifico_carnicero.aspx.cs" Inherits="SISTEMA_CARNICERIA.Especifico_carnicero" %>
...
<body>
        ...
        <div style="display:flex; flex-wrap:wrap; margin-bottom: 250px;">
                ...
                <div style="width: 80%; display:flex; flex-wrap:wrap; margin-top: 60px;"> 
                    <h1 style="min-width: 100%; display: flex; ">Pedidos despachados por los carniceros</h1> 
                    <div style="width:20%; padding:20px; display:flex; flex-wrap:wrap; justify-content:center; align-content:start;">
                        <div>
                            <h5>Seleccione un carnicero:</h5>
                        </div>
                        <div>
