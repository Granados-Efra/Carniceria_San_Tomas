<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registro_repartidor.aspx.cs" Inherits="SISTEMA_CARNICERIA.Registro_repartidor" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="display:flex; margin-bottom: 500px; margin-top:50px;">
                <div class="info-personal" style="width:40%; display:flex; flex-wrap: wrap !important; justify-content: center;margin-top: 20px;"> 
                        <h1 style="min-width: 100%; display: flex; padding-left: 255px;">Registro de repartidor</h1>  
                        <div style="width: 100%; max-height:200px; overflow: hidden; display: flex;justify-content: center;">
                            <img style="max-height: 200px;" src="./img/repartidor.jpg" alt=""/>
                        </div>        
                </div>
                ...
                <div style="width: 60%; display:flex; flex-wrap:wrap; margin-top: 60px;">  
                    ...
                    <div style="width:100%; display: flex;">
                     ...
                     <div style="width:100%; display: flex;">
                         <div style="width:15%">
                            <asp:Label CssClass="etiqueta" Text="Licencia" runat="server" /> 
                        </div>
                        <div style="width:85%">
                           <asp:TextBox CssClass="campo" style="margin-left:20px" ID="TextBox3" runat="server">Licencia</asp:TextBox> 
                        </div>         
                    </div> 
