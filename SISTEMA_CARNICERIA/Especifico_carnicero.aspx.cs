...
{
    public partial class Especifico_carnicero : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string msj = "";
                mostrarRepartidores = objAcceso2.ObtenerCarniceros(ref msj);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string msj = "";
            int carnicero_comparar = Convert.ToInt32(DropDownList1.SelectedValue.ToString());
            GridView1.DataSource = objAcceso.ObtenerEspecificoCarnicero(ref msj, ref fecha_comparar, ref carnicero_comparar);
            GridView1.DataBind();
