                ...
                <div style="width: 80%; display:flex; flex-wrap:wrap; margin-top: 60px; background-color:orangered;">  
                    ...
                    <asp:GridView ID="GridView1" runat="server" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1">
                     ...
                     <Columns>
                        ...
                        <itemtemplate>
                          <asp:Button cssClass="Granados" OnClick="eventoButton"  ID='LinkButton1' runat="server" Text="Ver Pedidos de este cliente" CommandArgument='<%# Bind("[Numero_Registro]")%>' >  </asp:Button>
                        </itemtemplate>
                      </asp:templatefield>
                     </Columns>
