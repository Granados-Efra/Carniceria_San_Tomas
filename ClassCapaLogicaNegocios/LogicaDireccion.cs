...
namespace ClassCapaLogicaNegocios
{
    public class LogicaDireccion
    {
        ...
        public Boolean InsertarDireccion(EntidadesDireccion entidadDir, ref string mensajeSalida)
        {
            ...
            //string sentencia = 
            //    "insert into Ubicacion(Colonia, Calleynumero, Municipio, Ciudad, Referencia, Caracteristica, CP) values(@colonia, @CalleNumero, @municipio, @ciudad, @referencia, @caracteristica, @cp) ";
